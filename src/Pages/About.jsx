    ...
    <div className="h-[100vh] px-4 md:px-40 py-5 text-white">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between ">
        ...
        <div className="bg-white p-8 h-full w-full rounded-2xl shadow hover:shadow-xl">
          <h2 className="font-poppins font-bold text-3xl bg-a-text bg-clip-text text-transparent">Experience</h2>
          <div className="bg-[#18182F] p-4 rounded-xl my-2 w-full h-full hover:scale-105 duration-300">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <h2 className="font-poppins text-white text-lg">Enzigma Sol. LLP Pvt Ltd.</h2>
              <h5 className="font-poppins text-white text-xs">Oct 2024 - Apr 2025</h5>
            </div>
            <p className="mt-2 font-poppins font-bold text-white text-xl w-full">
              Jr. Software Engineer
            </p>
            <p className="mt-2 font-poppins text-white text-base leading-relaxed w-full">
              Developed and maintained scalable Lightning Web Components (LWC) for Salesforce-native platforms
              like noKodr, PWR Forms, Docuweaver, and PWR Apps, enhancing UI responsiveness and performance.
            </p>
            <p className="mt-2 font-poppins text-white text-base leading-relaxed w-full">
              Resolved complex UI bugs and improved user workflows by debugging event handling, API integrations,
              and component rendering issues across multiple modules.
            </p>
          </div>
          <div className="bg-[#18182F] p-3 rounded-xl my-3 w-full h-full hover:scale-105 duration-300">
            <div className="flex items-center justify-between gap-6">
